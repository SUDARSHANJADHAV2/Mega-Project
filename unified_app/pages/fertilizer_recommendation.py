...
def load_model_components():
    ...
    try:
        model = pickle.load(open("KrushiAI-Fertilizer-Recommendation/Fertilizer_RF.pkl", "rb"))
        soil_encoder = pickle.load(open("KrushiAI-Fertilizer-Recommendation/soil_encoder.pkl", "rb"))
        crop_encoder = pickle.load(open("KrushiAI-Fertilizer-Recommendation/crop_encoder.pkl", "rb"))
        fertilizer_encoder = pickle.load(open("KrushiAI-Fertilizer-Recommendation/fertilizer_encoder.pkl", "rb"))

        # Load scaler and metrics if available
        try:
            scaler = pickle.load(open("KrushiAI-Fertilizer-Recommendation/feature_scaler.pkl", "rb"))
            model_metrics = pickle.load(open("KrushiAI-Fertilizer-Recommendation/model_metrics.pkl", "rb"))
        except:
            scaler = None
            model_metrics = None
