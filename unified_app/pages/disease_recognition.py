...
try:
    ...
    from KrushiAI-Disease-Recognition.utils import ImageProcessor, ModelPredictor, ModelAnalyzer, format_disease_name, get_severity_color, create_confidence_message
    from KrushiAI-Disease-Recognition.disease_info import get_disease_info, get_all_diseases, get_diseases_by_plant, get_severity_stats
...
def load_model_predictor():
    ...
    try:
        ...
        model_path = "KrushiAI-Disease-Recognition/trained_plant_disease_model.keras"
...
def load_model_analyzer():
    ...
    try:
        ...
        hist_path = "KrushiAI-Disease-Recognition/training_hist.json"
...
def show_detection_page():
    ...
    if uploaded_file is not None:
        ...
        test_dir = "KrushiAI-Disease-Recognition/test"
