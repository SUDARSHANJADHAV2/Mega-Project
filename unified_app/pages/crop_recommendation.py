...
with col1:
    ...
    try:
        img = Image.open("KrushiAI-Crop-Recommendation/crop.png")
...
@st.cache_data
def load_data():
    return pd.read_csv('KrushiAI-Crop-Recommendation/Crop_recommendation.csv')

# Load the model
@st.cache_resource
def load_model():
    return pickle.load(open('KrushiAI-Crop-Recommendation/RF.pkl', 'rb'))
